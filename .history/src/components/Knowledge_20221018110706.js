        ...
        <div>
          <div className="">
            <div>
              ...
              <div className="text-4xl flex justify-center gap-10 py-3 text-cyan-500 sm:py-2 lg:text-5xl">
                <div>
                  <SiJavascript />
                </div>
                <div>
                      ...
                      <Tooltip.Portal>
                        <Tooltip.Content>
                          <p>
                            ...
                            like flex, pt-4, text-center and rotate-90 that can
                            be composed to build any design, directly in your
                            markup.
                          </p>
                        </Tooltip.Content>
                      </Tooltip.Portal>
