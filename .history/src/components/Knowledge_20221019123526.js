...
export function Knowledge() {
  return (
    <div className="h-full mb-10 py-20" id="knowledge">
      <div>
        <h2 className="text-center text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-gray-700 px-2 py-2 md:text-3xl">
          Knowledge
        </h2>
        <h3 className="text-left text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-gray-700 mb-4 md:text-xl">
          Technologies Studied
        </h3>
        <div className="text-4xl flex flex-wrap justify-center gap-10 py-3 text-blue-500 sm:py-2 lg:text-5xl">
          <div>
            <Tooltip.Provider>
              <Tooltip.Root>
                <Tooltip.Trigger>
      ...
      <div className="mt-4 dark:text-white">
        <h2 className="text-left text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-gray-700 mb-4 md:text-xl ">
          Courses
        </h2>
        <div>
          <ul className="flex flex-wrap w-85 px-8 gap-4 align-center justify-between  text-gray-800  dark:text-gray-200">
            <li>
