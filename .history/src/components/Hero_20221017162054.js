  ...
  return (
    <div className='px-2 mb-4 items-center'>
      <div className='flex align-center sm:flex flex-col md:flex-row lg:flex-row'>
        ...
        <h2 className=" text-center  align-left text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-cyan-700 text-white px-4 py-2 rounded-md md:text-6xl">
          Guilherme Cardoso
        </h2>
