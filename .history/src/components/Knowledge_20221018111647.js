                ...
                <div>
                  <Tooltip.Provider>
                    <Tooltip.Root>
                      ...
                      <Tooltip.Portal>
                        <Tooltip.Content>
                          <p className="w-20 rounded-md bg-slate-500 py-1 text-white text-center text-sm overflow-hidden">
                            <strong>Reacts</strong>framework is an open-source
                            JavaScript framework and library developed by
                            Facebook.
                          </p>
                        </Tooltip.Content>
                      </Tooltip.Portal>
