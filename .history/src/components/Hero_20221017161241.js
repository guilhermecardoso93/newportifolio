  ...
  return (
    <div className='px-2 mb-4 items-center'>
      ...
      <div className="items-center p-4">
        <p className="text-justify text-md py-4 leading-2 text-gray-800 md:text-lg lg:text-lg lg:px-60 ">
      ...
      <div>
        <ul className="text-5xl flex justify-center gap-10 py-3 text-cyan-500 sm:py-2 sm:text-3xl">
          <li>
            <a
