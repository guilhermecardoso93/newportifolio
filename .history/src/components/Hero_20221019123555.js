  ...
  return (
    <div className="px-2 py-10 pb-4 items-center" id="home">
      <div className="flex align-center py-10 sm:flex flex-col md:flex-row lg:flex-row">
        <div className="bg-gradient-to-t from-blue-500 to-white overflow-hidden rounded-full mt-2 mx-auto lg:h-120 lg:w-120">
          <Image
            src={ImageProfile}
            width={720}
            height={720}
        ...
        <div className="flex flex-col justify-center">
          <h2 className="text-center text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-gray-700 px-4 py-2 rounded-md md:text-6xl">
            Guilherme Cardoso
          </h2>
      ...
      <div>
        <ul className="text-4xl flex justify-center gap-6 py-3sm:py-2 lg:text-5xl">
          <li>
            <a
            ...
            >
              <AiFillInstagram className="hover:text-blue-300 text-blue-500" />
            </a>
          </li>
          <li>
            <a
              ...
              rel="noopener noreferrer"
            >
              <AiOutlineMail className="hover:text-blue-300 text-blue-500" />
            </a>
          </li>
          <li>
            <a
              ...
              rel="noopener noreferrer"
            >
              <AiOutlineWhatsApp className="hover:text-blue-300 text-blue-500" />
            </a>
          </li>
          <li>
            <a
              ...
              rel="noopener noreferrer"
            >
              <AiFillLinkedin className="hover:text-blue-300 text-blue-500" />
            </a>
          </li>
          <li>
            <a
              ...
              rel="noopener noreferrer"
            >
              <AiFillGithub className="hover:text-blue-300 text-blue-500" />
            </a>
          </li>
          <li>
            <a
              ...
              rel="noopener noreferrer"
            >
              <AiFillTwitterCircle className="hover:text-blue-300 text-blue-500" />
            </a>
          </li>
        </ul>
      </div>
