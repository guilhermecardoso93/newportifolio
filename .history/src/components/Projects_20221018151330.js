...
export function Projects() {
  return (
    <div className="flex flex-col gap-2 items-center text-white rounded">
      ...
      <div class="flex auto flax-wrap flex-col">
        {projects.map((project, index) => {
          return (
            <div
              className="proj-imgbx shadow-lg w-56 max-h-36 rounded-xl my-2 flex-1 justify-center"
              key={index}
            >
              <img
                src={project.img}
                layout="fill"
                alt=""
                className="proj-imgbx-back rounded-xl"
              />
