                ...
                <div>
                  <Tooltip.Provider>
                    <Tooltip.Root>
                      ...
                      <Tooltip.Portal>
                        <Tooltip.Content>
                          <span className="w-20 rounded-md bg-slate-500 py-2 text-white text-center text-sm overflow-hidden">
                ...
                <div>
                  <Tooltip.Provider>
                    <Tooltip.Root>
                      ...
                      <Tooltip.Portal>
                        <Tooltip.Content>
                          <span className="w-20 rounded-md bg-slate-500 py-1 text-white text-center text-sm">
