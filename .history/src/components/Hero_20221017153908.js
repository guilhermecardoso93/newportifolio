...
export function Hero() {
  return (
    <>
     <div className='relative bg-gradient-to-t from-cyan-500 to-white overflow-hidden rounded-full w-80 h-80 mt-10 mx-auto'>
        <Image src={ImageProfile} layout='fill' objectFit="cover"/>
      </div>
      <div className='items-center p-10'>
        <h2 className=' text-center text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-cyan-700 text-white px-4 py-2 rounded-md md:text-4xl'>Guilherme Cardoso</h2>
